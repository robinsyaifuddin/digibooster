      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12 lg:gap-20">
          <AnimatedSection className="md:w-5/12 lg:w-5/12" animation="slideLeft">
            <span className={cn(
              "inline-block py-1 px-3 text-xs font-medium rounded-full mb-3",
              theme === 'light' ? "text-digiblue bg-digiblue/10" : "text-neon-cyan bg-neon-cyan/10"
            )}>
              {t('our-advantages')}
            </span>
            ...
            <h2 className={cn(
              ...
              theme === 'light' ? "text-diginavy-900" : "text-white"
            )}>
          ...
          <AnimatedSection className="md:w-6/12" animation="slideRight">
            ...
            <div className="relative mt-10 rounded-xl overflow-hidden shadow-lg">
              <div className={cn(
                "absolute -top-4 -left-4 w-20 h-20 rounded-lg opacity-20",
                theme === 'light' ? "bg-digiblue" : "bg-neon-cyan"
              )}></div>
              <div className={cn(
                "absolute -bottom-4 -right-4 w-20 h-20 rounded-lg opacity-20",
                theme === 'light' ? "bg-digiblue-700" : "bg-neon-blue"
              )}></div>
              <img 
